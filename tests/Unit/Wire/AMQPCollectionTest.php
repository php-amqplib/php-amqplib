...
class AMQPCollectionTest extends TestCase
{
        ...
        $this->assertEquals(
            array(
                ...
                array(
                    ...
                    array('foo' => array(Wire\AMQPAbstractCollection::getDataTypeForSymbol('S'), 'bar'))
                ),
                array(
                    Wire\AMQPAbstractCollection::getDataTypeForSymbol('F'),
        ...
        $this->assertEquals(
            array(
                ...
                array(
                    ...
                    array(array(Wire\AMQPAbstractCollection::getDataTypeForSymbol('S'), 'foo'))
                ),
    ...
    public function testPushWithType()
    {
        ...
        $this->assertEquals(
            array(
                ...
                array(
                    Wire\AMQPAbstractCollection::getDataTypeForSymbol('A'),
                    array(array(Wire\AMQPAbstractCollection::getDataTypeForSymbol('S'), 'bar'))
                )
            ),
            $this->getEncodedRawData($a)
        );
    ...
    public function testIterator()
    {
        ...
        foreach ($a as $key => $val) {
            ...
            $this->assertEquals($ed[$key], $val[1] instanceof Wire\AMQPAbstractCollection ? array(
                $val[0],
                $this->getEncodedRawData($val[1])
            ) : $val);
        }
    }
}
